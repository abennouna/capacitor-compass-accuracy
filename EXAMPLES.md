...
This directory contains examples demonstrating how to use the @abennouna/capacitor-compass-accuracy plugin.
...
import { CompassAccuracy, AccuracyLevel, AccuracyChangeResult } from '@abennouna/capacitor-compass-accuracy';
